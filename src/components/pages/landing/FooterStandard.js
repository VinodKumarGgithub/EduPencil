...
import edupencil from "assets/img/logos/edupencil-logo.png"
  ...
  return (
    <>
      <Section bg="dark" className="pt-8 pb-4 light">
        ...
        <Row>
          <Col lg={4}>
            <FooterTitle>Edupencil</FooterTitle>
        ...
        <div className="container py-3">
          <Row className="justify-content-between">
            <Col xs={12} sm="auto">
              ...
              Made with <span> <FontAwesomeIcon icon="heart" className="fa-regular fa-heart" /></span>  in India 
                ...
                >
                  <img src={edupencil} alt='Edupencil' height="15" /> 
                </a>
              </p>
            </Col>
            <Col xs={12} sm="auto">
