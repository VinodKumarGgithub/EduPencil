...
import ContactUs from 'components/pages/faq/faq-alt/ContactUs';
  ...
  return (
    <Routes>
      ...
      <Route element={<MainLayout />}>
        ...
        {/* E Learning */}
        <Route path="/institutions/course/course-list" element={ }/>
        ...
        <Route path="/landing/contact" element={<ContactUs />} />
